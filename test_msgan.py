#import os
#os.chdir('/Users/haoting/Desktop/MSc_code/CondNF')
#os.system('python train.py --model_name MSGAN --n_epochs 3 --n_epochs_decay 3 --batch_size 4 --lambda_L1 100.0 --netD n_layers --n_layers_D 5 --subset 0.1 --gpu_ids -1')
#!python train.py --model_name 'MSGAN' --n_epochs 3 --n_epochs_decay 3 --batch_size 4 --lambda_L1 100.0 --netD 'n_layers' --n_layers_D 5 --subset 0.1 --gpu_ids -1
