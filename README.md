This repository contains code for an ongoing research project on conditional generative models. Its implementation of U-Net and pix2pix are modified from the original authors of pix2pix:

- Image-to-Image Translation with Conditional Adversarial Networks.<br>
[Phillip Isola](https://people.eecs.berkeley.edu/~isola), [Jun-Yan Zhu](https://people.eecs.berkeley.edu/~junyanz), [Tinghui Zhou](https://people.eecs.berkeley.edu/~tinghuiz), [Alexei A. Efros](https://people.eecs.berkeley.edu/~efros). In CVPR 2017. [[arxiv]](https://arxiv.org/abs/1611.07004)
