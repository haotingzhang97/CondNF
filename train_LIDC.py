...
if __name__ == '__main__':
    ...
    np.save('/content/drive/My Drive/Colab Notebooks/CondNF_ver1/savedmodel/train_loss.npy', train_loss_vec)
    np.save('/content/drive/My Drive/Colab Notebooks/CondNF_ver1/savedmodel/val_loss.npy', val_loss_vec)
